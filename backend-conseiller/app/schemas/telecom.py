...
class CustomerTelecomDetailOut(BaseModel):
    ...
    cdr_history: list[CdrRecordOut] = []

    @model_validator(mode="before")
    @classmethod
    def build_balances(cls, obj):
        if hasattr(obj, "main_credit"):  # objet SQLAlchemy
            return {
                "msisdn": obj.msisdn,
                ...
                "cdr_history": getattr(obj, "cdr_history", []) or [],
            }
        return obj

# Alias pour compatibilité
CustomerTelecomOut = CustomerTelecomDetailOut
