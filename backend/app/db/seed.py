...
def init_db():
    ...
    et insère les données de base si la base est vide.
    """
    ...
    try:
        ...
        adv1 = Advisor(
            ...
            password_hash="$2b$12$e8YkYgD8k1/...",
        ...
        # 3. Client 1 : Jean-Marc KOFFI (0708091011)
        c1 = Customer(
            id="CUST-CI-001",
        ...
        # 4. Client 2 : Marie-Josée ABLAN (0744556677)
        c2 = Customer(
            id="CUST-CI-002",
