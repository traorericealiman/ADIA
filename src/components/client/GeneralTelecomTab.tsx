          ...
          <div>
            ...
            <div className="mt-4 space-y-3.5 text-xs">
              ...
              <div className="flex items-center justify-between py-1 border-b border-gray-100">
                ...
                <span className="font-semibold text-gray-900">{selectedCustomer.dateOfBirth} ({selectedCustomer.gender === 'M' ? 'Homme' : 'Femme'})</span>
              </div>
              ...
              <div className="flex items-center justify-between py-1 border-b border-gray-100">
                ...
                <span className="text-gray-900 truncate max-w-xs">{selectedCustomer.address}, {selectedCustomer.city}</span>
              </div>
      ...
      <div className="bg-white border-2 border-gray-200 p-6 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-gray-50 border border-gray-300">
            ...
            <div className="mt-2 text-xs text-gray-500">
              Sur {(telecom.balances.dataTotalMB / 1024).toFixed(0)} Go • Expire le : {telecom.balances.dataExpiry}
            </div>
          </div>
          ...
          <div className="p-4 bg-gray-50 border border-gray-300">
            ...
            <div className="mt-2 text-xs text-emerald-700 font-bold">
              Bonus Voix : +{telecom.balances.bonusOrange.toLocaleString()} FCFA
            </div>
          </div>
